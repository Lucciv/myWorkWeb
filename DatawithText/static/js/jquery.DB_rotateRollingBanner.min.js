        ...
        return this.each(function() {
            ...
            function d() {
                ...
                for (var E = 0; E < p; E++) {
                    ...
                    x.push(D);
                    var F=E+1;
//                  j.append("<li style='margin-right:15px;color:#e55261;font-size:14px;font-weight:bold'>"+ F +"</li>")
                    j.append("<li style='margin-right:15px;color:#e55261;font-size:14px;font-weight:bold'></li>")
                }
                r = j.find(">li");
